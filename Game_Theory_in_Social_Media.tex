...
\title{Game Theory in Social Media: A Continuous Stackelberg Model of Algorithmic Incentives and Multi-Agent Influencer Dynamics}
\author{By Arjan Khadka \\
	\texttt{arjank898@gmail.com}}
...
\begin{table*}[htbp]
	...
	\begin{tabular}{l c c c l l}
		\toprule
		\textbf{Algorithmic Priorities} & $\alpha$ (Clicks) & $\beta$ (Retention) & $\gamma$ (Virality) & $\delta$ (Sponsors) & \textbf{Resulting Population $d^*$ Eq.} \\
		\midrule
		\textbf{Watch-Time Centric Era} & 0.5 & 3.0 & 0.5 & 5.0 (Strict) & $d^* \approx 0.05$ (Highly Collaborative) \\
		\textbf{Balanced Modern Feed} & 1.5 & 1.5 & 1.5 & 2.5 (Moderate) & $d^* \approx 0.38$ (Calculated Agitation) \\
		\textbf{Short-Form Virality Boom} & 3.5 & 0.2 & 2.5 & 1.0 (Lenient) & $d^* \approx 0.89$ (Intense Beefing/Conflict) \\
		\textbf{Demonetization Event} & 4.0 & 0.1 & 3.0 & \textbf{20.0} (Nuclear) & $d^* \approx 0.12$ (Forced Pacifism) \\
		\bottomrule
	\end{tabular}
\end{table*}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.9\linewidth]{graphs/phase_diagram.png}
...
\begin{figure*}[htbp]
	\centering
	\includegraphics[width=0.48\textwidth]{graphs/utility_curves.png}
	\hfill
	\includegraphics[width=0.48\textwidth]{graphs/scatter_convergence.png}
	\caption{\textbf{Left:} Mapped normalized Creator Utility ($U$) against Strategy Choice ($d$) under two opposite algorithmic regimes. \textbf{Right:} Continuous scatter plot of 100 localized Deep-RL Creators traversing strategy space over 10,000 epochs. A black indicator boundary at epoch 5000 signifies the macro-algorithm radically altering internal mathematical weights, forcing an immediate, panicked population migration to the extreme upper bounds of the hostility continuum.}
	\label{fig:convergence}
\end{figure*}

\section{Multi-Agent Reinforcement Learning (MARL) Simulation Dynamics}
Our empirical query array perfectly contextualizes a single static snapshot of modern platforms, but online networks are deeply dynamic \cite{young2015strategic}. To simulate the systemic temporal evolution of these ecosystem forces—and to scientifically visualize macro-transitions—we engineered a Multi-Agent Reinforcement Learning Python architecture \footnote{The complete deep learning python simulations, graph rendering scripts, and API extraction tools utilized for this manuscript are structurally open-sourced and indexed at: \url{https://github.com/Azaxek/social-media-marl-simulation}}. 
...
\begin{thebibliography}{15}
	...
	\bibitem{tang2019} Tang, J., Jiang, M., Zhang, Y., \& Yan, X. (2019). A Stackelberg Game Model for Content Promotion in Social Media Platforms. \textit{IEEE Transactions on Computational Social Systems}, 6(2), 278--287.
	...
	\bibitem{young2015strategic} Young, H. P. (2015). \textit{Strategic Learning and Its Limits}. Oxford University Press.
	\bibitem{liu2020cross} Liu, C., Wang, Z., \& Zhang, J. (2020). Cross-platform content strategy: Evidence from social media creators. \textit{Journal of Interactive Marketing}, 52, 26--43.
	\bibitem{kizilcec2021algorithms} Kizilcec, R. F., Marder, B., Reich, J., \& Brooks, C. (2021). Algorithms and creators: Feedback and adjustment on YouTube. \textit{Journal of Learning Analytics}, 8(2), 1--20.
